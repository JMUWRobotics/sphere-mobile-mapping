...
{    
    ...
    if (imu_buffer_.empty() || imu_buffer_.front().stamp < end_time){
        ...
        // Check if condition is actually met before unblocking
    ...
    for(; imu_corr_it != end_imu_it; imu_corr_it++) {
        ...
        while (imu_1.stamp > lidar_it->timestamp && lidar_it != pc_in->points.end()){
            ...
            // TODO: Check the following interpolation if temporal calibration is not usefull
            ...
            // TODO: Also consider the position of the scanner! 
