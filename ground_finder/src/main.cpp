...
int main(int argc, char** argv){
    ...
    if(!nh.getParam("/ground_finder_node/file", filename)){
        ...
        if(strcmp(filename.c_str(), "default")){
            ...
            switch (plane_alg){
            case LSF:
                path = "/home/deadalus/catkin_ws/src/ground_finder/data/lsf/" + filename;
                break;
            case PCA:
                path = "/home/deadalus/catkin_ws/src/ground_finder/data/pca/" + filename;
                break;
            case RANSAC:
                path = "/home/deadalus/catkin_ws/src/ground_finder/data/ran/" + filename;
                break;
            case RHT:
                path = "/home/deadalus/catkin_ws/src/ground_finder/data/rht/" + filename;
                break;
            case RHT2:
                path = "/home/deadalus/catkin_ws/src/ground_finder/data/rht2/" + filename;
                break;
            }
